...
**Reference docs (`references/comfyui/`):**
...
**Example workflows (`templates/comfyui/workflows/`):** SD 1.5, SDXL, Flux Dev, SDXL img2img,
SDXL inpaint, ESRGAN upscale, AnimateDiff video, Wan T2V. See
`templates/comfyui/workflows/README.md`.
...
- This skill's `templates/comfyui/workflows/` directory (ready-to-run examples)
...
4. Run workflows:
   ```bash
   python3 scripts/comfyui/run_workflow.py \
     --workflow templates/comfyui/workflows/flux_dev_txt2img.json \
     --args '{"prompt": "..."}' \
     --host https://cloud.comfy.org \
     --output-dir ./outputs
   ```
...
python3 scripts/comfyui/run_workflow.py \
  --workflow templates/comfyui/workflows/sd15_txt2img.json \
...
```bash
python3 scripts/comfyui/run_workflow.py \
  --workflow templates/comfyui/workflows/sdxl_img2img.json \
  --input-image image=./photo.png \
...
```bash
python3 scripts/comfyui/run_workflow.py \
  --workflow templates/comfyui/workflows/sdxl_inpaint.json \
  --input-image image=./photo.png \
