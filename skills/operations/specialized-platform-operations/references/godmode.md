...
exec(open(os.path.expanduser(
    os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.hermes")), "skills/operations/specialized-platform-operations/scripts/godmode/load_godmode.py")
)).read())
...
exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.hermes")), "skills/operations/specialized-platform-operations/scripts/godmode/parseltongue.py")).read())
...
```python
# Via execute_code
exec(open(os.path.join(os.environ.get("HERMES_HOME", os.path.expanduser("~/.hermes")), "skills/operations/specialized-platform-operations/scripts/godmode/godmode_race.py")).read())
