...
See `references/voice-calling-operations/retell-disposable-roleplay-resources.md` for the Retell-specific disposable-resource recipe and verification pattern.
...
See `references/voice-calling-operations/private-contact-and-simulation-preflight.md` for the privacy-safe contact pattern, simulation interpretation, scenario-sheet fields, and reporting standard.
