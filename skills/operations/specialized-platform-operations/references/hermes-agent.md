...
(`hermes mcp install <name>`): `skill_view(name="hermes-agent", file_path="references/hermes-agent/native-mcp.md")`.
...
patterns: `skill_view(name="hermes-agent", file_path="references/hermes-agent/webhooks.md")`.
...
- Use class-level SKILL.md files with `references/hermes-agent/`, `templates/hermes-agent/`, and `scripts/hermes-agent/` for detail.
