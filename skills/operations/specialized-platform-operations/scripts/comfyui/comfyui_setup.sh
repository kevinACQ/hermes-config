...
#   bash scripts/comfyui/comfyui_setup.sh --nvidia
#   bash scripts/comfyui/comfyui_setup.sh --m-series --port=8190
#   bash scripts/comfyui/comfyui_setup.sh --amd --workspace=/data/comfy
#
# Flags:
