...
python3 -m pytest scripts/comfyui/tests/ -c scripts/comfyui/tests/pytest.ini -o addopts="-p no:xdist"

# Including cloud integration tests
COMFY_CLOUD_API_KEY="comfyui-..." python3 -m pytest scripts/comfyui/tests/ \
  -c scripts/comfyui/tests/pytest.ini -o addopts="-p no:xdist"

# Just cloud tests
COMFY_CLOUD_API_KEY="comfyui-..." python3 -m pytest scripts/comfyui/tests/test_cloud_integration.py \
  -c scripts/comfyui/tests/pytest.ini -o addopts="-p no:xdist" -v
```
...
environment. The `-c scripts/comfyui/tests/pytest.ini -o addopts="-p no:xdist"` flags make
