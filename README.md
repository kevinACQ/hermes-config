...
- `restore_from_backup.py` restores `SOUL.md`, `config.yaml`, `memories/`, `skills/`, and `scripts/` from any git commit while first backing up the current live files under `~/.hermes/backups/restore/`.
